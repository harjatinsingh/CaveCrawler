...
class subandpub
{
    ...
    ros::Publisher pub1;
  	...
  	void cloud_process (const sensor_msgs::PointCloud2ConstPtr& input)
  	{
		...
		range_cond->addComparison (pcl::FieldComparison<pcl::PointXYZ>::ConstPtr (new
		pcl::FieldComparison<pcl::PointXYZ> ("x", pcl::ComparisonOps::LT, 5.0)));
		range_cond->addComparison (pcl::FieldComparison<pcl::PointXYZ>::ConstPtr (new
		pcl::FieldComparison<pcl::PointXYZ> ("y", pcl::ComparisonOps::GT, -5.0)));
		range_cond->addComparison (pcl::FieldComparison<pcl::PointXYZ>::ConstPtr (new
		pcl::FieldComparison<pcl::PointXYZ> ("y", pcl::ComparisonOps::LT, 5.0)));
		// build the filter
